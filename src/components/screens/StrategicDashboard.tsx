      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        <div>
          <div className="flex items-center gap-2 text-indigo-600 text-xs font-bold uppercase tracking-wider mb-1">
            <TrendingUp className="h-4 w-4" /> Strategic Executive Dashboard
          </div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">
            Fleet Operations & Decision Matrix
          </h1>
          <p className="text-sm text-slate-500 mt-0.5">
            Real-time aggregate telemetry, cost distribution, and mathematical risk evaluation for role:{' '}
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500">
              ({healthyVehicles}/{totalVehicles} Operational)
            </span>
          </div>
